...
class SurroundView:
    def __init__(self):
        # subscribe the image
        # print("a")
        self.cv_bridge = CvBridge() # ros image massage
        ...
        self.car = cv2.imread('/home/juntae/catkin_ws/src/pd513/src/budicar.jpg')
        # cv2.imsave('car.png', self.car)
        self.car = cv2.resize(self.car, dsize=(480,640),interpolation=cv2.INTER_LINEAR)
        self.car = cv2.rotate(self.car, cv2.ROTATE_90_CLOCKWISE)
    ...
    def img_front_callback(self, data):
        if not self.is_front:
            ...
            # print("d")
            cv2.imwrite("/home/juntae/catkin_ws/src/pd513/src/image/front.jpg", self.cur_img_front)
            self.is_front = True
    ...
    def img_left_callback(self, data):
        if not self.is_left:
            ...
            # print("a")
            cv2.imwrite("/home/juntae/catkin_ws/src/pd513/src/image/left.jpg", self.cur_img_left)
            self.is_left = True
    ...
    def img_right_callback(self, data):
        if not self.is_right:
            ...
            # print("b")
            cv2.imwrite("/home/juntae/catkin_ws/src/pd513/src/image/right.jpg", self.cur_img_right)
            self.is_right = True
    ...
    def img_back_callback(self, data):
        if not self.is_back:
            ...
            cv2.imwrite("/home/juntae/catkin_ws/src/pd513/src/image/rear.jpg", self.cur_img_back)
