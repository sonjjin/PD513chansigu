        ...
        if self.is_front and self.is_left and self.is_right and self.is_back:
            if self.is_first:
                ...
                try:
                    ...
                    out_frame = cv2.line(out_frame, (left.shape[1]-130, 0), (left.shape[1]-130, out_frame.shape[0]), (0,0,255), 3)
                    out_frame = cv2.line(out_frame, (left.shape[1]+self.car_width-10, 0), (left.shape[1]+self.car_width-10, out_frame.shape[0]), (0,0,255), 3)
